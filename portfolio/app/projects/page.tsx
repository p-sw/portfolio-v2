...
function Project({
  ...
  const rawSvgColor = useColorModeValue(
    "var(--chakra-colors-text-1000)",
    "var(--chakra-colors-wtext-1000)"
  );
    ...
    >
      ...
      >
        ...
        <Flex
          ...
          onClick={onClose}
          zIndex={10}
          className={`proj-folder${isOpen ? " visible" : ""}`}
        >
          <Heading
            as={"h1"}
            color={"#fff"}
          ...
          >
            <Icon
              ...
              cursor={"pointer"}
              onClick={() => {
                setAppHref(undefined);
                setAppContent(children);
                setAppOpen();
              }}
            />
            {github ? (
...
export default function Projects() {
  let [{ href, children, appOpen }, setAppState] = useState<AppProps>({
    href: undefined,
    children: "",
    appOpen: false,
    appClose: () => {},
  ...
  return (
    <>
      <FullscreenApp
        appOpen={appOpen}
        href={href}
        appClose={() => setAppState((prev) => ({ ...prev, appOpen: false }))}
      >
        {children}
      </FullscreenApp>
      <Grid
        gridTemplateColumns={
          "repeat(auto-fit, minmax(var(--chakra-space-24), 1fr))"
        }
        gridGap={6}
        w={"full"}
        p={[6, null, 12]}
      ...
      >
        <Project
          ...
          link={"https://nyanlang.org"}
          setAppContent={setAppContent}
          setAppHref={setHref}
          setAppOpen={setAppOpen}
        >
          <Text>
            Nyanlang is a programming language highly inspired by the Brainfuck
            programming language.
          </Text>
        </Project>
        <Project
          title={"Nyanlang Extension"}
          github={"https://github.com/nanlang/nyanlang-vscode-ext"}
          setAppContent={setAppContent}
          setAppHref={setHref}
          setAppOpen={setAppOpen}
        >
          <Text>VSCode syntax highlighting extension for Nyanlang.</Text>
        </Project>
        <Project
          title={"DodgeGame"}
        ...
        >
          <Text>
            DodgeGame made for Bupyeong High School festival.
            <br />
            Leaderboard API backend is included in this project repository.
            <br />
        ...
        >
          <Text>
            Leaderboard web app for DodgeGame.
            <br />
        ...
        <Project
          ...
          setAppOpen={setAppOpen}
        >
          <Text>Simple calculator GUI written in Python, Pygame.</Text>
        </Project>
        <Project
        ...
        >
          <Text>
            Womp sound, global counter.
            <br />
            It&apos;s working, but not online because I messed up it&apos;s
            nginx configuration.
          </Text>
        </Project>
        <Project
